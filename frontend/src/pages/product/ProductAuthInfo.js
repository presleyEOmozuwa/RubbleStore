      ...
      <div className='row'>
        ...
        <div className='col-lg-4 p-4 shadow sect mb-2 rounded'>
          ...
          <div className='text-center mt-4'>
            ...
            <AddToCartAuthUser productId={id} typeOfItem={typeOfItem} />
          </div>
        </div>
...
export default ProductAuthInfo
